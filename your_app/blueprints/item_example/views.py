...
from your_app.blueprints.item_example.resources.item_resource import ItemResource
from your_app.blueprints.item_example.resources.single_item_resource import SingleItemResource

# registers a new item blueprint
item = Blueprint('item', __name__, url_prefix='/item', template_folder='templates')
